...
const FindNewMotifsProgress: React.FC<FindNewMotifsProgressProps> = ({
    ...
    const [motifFindingTime, setMotifFindingTime] = useState<number | null>(
        null
    );
    ...
    useEffect(() => {
        if (progressLogRef.current) {
            progressLogRef.current.scrollTop =
                progressLogRef.current.scrollHeight;
        }
    }, [progressUpdates]);
    ...
    useEffect(() => {
        progressUpdates.forEach((update) => {
            if (
                !setupTime &&
                update.includes("Time cost for loading motif libs")
            ) {
        ...
        setupTime !== null && motifFindingTime === null ? (
            ...
            motifFindingTime !== null && (
                <p key="motif-complete">
                    Undesignable Motifs found in {motifFindingTime.toFixed(4)}{" "}
                    seconds
                </p>
            )
        ),
            ...
            <div style={{ width: "80%" }}>
                ...
                <div className="header-bar">
                    <div className="header-section">
                        <h3 style={{ margin: 0, marginLeft: "8px" }}>
                            Progress Info
                        </h3>
                    </div>
                    <div className="header-section">
