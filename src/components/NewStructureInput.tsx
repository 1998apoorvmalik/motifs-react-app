...
const NewStructureInput: React.FC<NewStructureInputProps> = ({
        ...
        Object.keys(predefinedStructures).find(
            (key) =>
                predefinedStructures[
                    key as keyof typeof predefinedStructures
                ] === inputValue
        ) || "";
    ...
    const handleStructureSelect = (
        ...
        const structure = event.target
            .value as keyof typeof predefinedStructures;
        ...
        <div id="overlay" className="overlay">
            <div className="dialog-box">
                ...
                <h2 style={{ marginBottom: "6px" }}>
                    Find Undesignable Motifs in an Input Structure
                </h2>
                <p className="p-nomargin info" style={{ marginBottom: "6px" }}>
                    (Pseudoknots are not allowed. Brackets other than '(' or ')'
